...
public class JobExecutor extends HttpServlet{
...
//List<String> syncal = Collections.synchronizedList(new ArrayList<String>());
    ...
    public static String main( )throws InterruptedException {
        ...
        try {
            ...
            Apfloat start1 = new Apfloat(data0, 26);
            Apfloat end1 = new Apfloat(data1, 26);
            Apfloat step1 = new Apfloat(data2, 26);
